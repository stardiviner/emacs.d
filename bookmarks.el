...
("0xDEADCODE"
 (filename . "~/Org/Projects/Projects.org")
 (front-context-string . "*** TODO 0xDEADC")
 (rear-context-string . "20:20 Fri +1d>\n\n")
 (position . 6608))
("Entertainment (Org -> Tasks)"
 (filename . "~/Org/Tasks.org")
 (front-context-string . "Entertainment [3")
 (rear-context-string . "267/\n\n\n* REPEAT ")
 (position . 48940))
("C test.c (Templates/Code)"
 (filename . "~/Templates/Code/C/test.c")
 (front-context-string . "#include <stdio.")
 (rear-context-string)
 (position . 1))
("Ruby test.rb (Templates/Code)"
 (filename . "~/Templates/Code/Ruby/test.rb")
 (front-context-string . "  \n      \n    en")
 (rear-context-string . " if a == 2\n\n    ")
 (position . 102))
("Bookmarks (Org)"
...
("Clothes (Org)"
 ...
 (front-context-string . "* Clothes (衣服)\n[")
 (rear-context-string)
 (position . 1))
("Dance (Org)"
 (filename . "~/Org/Wiki/Dance/Dance.org")
...
("Investing & Financing (Org)"
 ...
 (position . 1))
("Business (Org)"
 (filename . "~/Org/Wiki/Business/Business.org")
 (front-context-string . "Temp\n\n** 1\n    =")
 (rear-context-string . "ta\n\n** Books\n\n* ")
 (position . 30))
("Economy (Org)"
 (filename . "~/Org/Wiki/Economy/Economy.org")
 (front-context-string . "* Sharing Econom")
 (rear-context-string . "oks\n\n* styles\n\n*")
 (position . 39))
("Health (Org)"
 (filename . "~/Org/Wiki/Health/Health.org")
 (front-context-string . "\n\n\n* Neck (颈) \n\n")
 (rear-context-string . "(蛀牙)\n\n**** 冠周炎\n\n")
 (position . 2555))
("Sociology (Org)"
...
("Mathematics (Org)"
 ...
 (position . 156))
("Ethology (Org)"
 (filename . "~/Org/Wiki/Ethology/Ethology.org")
 (front-context-string)
 (rear-context-string . " Data\n\n\n** Books")
 (position . 28))
("Psychology (Org)"
...
("Myself (Org)"
 ...
 (position . 1))
("Objects (Org)"
 (filename . "~/Org/Wiki/Objects/Objects.org")
 (front-context-string . "* Cloth (衣服)\n\n* ")
 (rear-context-string)
 (position . 1))
("Experience (Org)"
...
("Softwares (Org)"
 ...
 (position . 18796))
("Commands (Org)"
 (filename . "~/Org/Wiki/Computer/Systems/Linux/Commands/Commands.org")
 (front-context-string . "[[file:wget.org]")
 (rear-context-string . "\n** Download\n\n- ")
 (position . 1689))
("Linux (Org)"
