...
(define-abbrev-table 'defn '())

(define-abbrev-table 'defun '())
...
(define-abbrev-table 'jupyter-repl-mode-abbrev-table '())

(define-abbrev-table 'jupyter-server-kernel-list-mode-abbrev-table '())
...
(define-abbrev-table 'redis-cli-mode-abbrev-table '())

(define-abbrev-table 'redis-mode-abbrev-table '())
...
(define-abbrev-table 'snails-mode-abbrev-table '())
