...
(setq org-tag-alist
      '((:startgroup) ("Org" . ?o) ("translate" . ?t) ("idea" . ?i) ("suggested") (:endgroup)

        ;; Task
        (:startgrouptag) ("@task" . nil) (:grouptags)
        ("table")
        ("event") ("check") ("alert") ("important") ("flag") ("label") ("question") ("info") ("quote")
        ...
        ("camera") ("vlog") ("record")
        ("chart")
        ("bicycle") ("car") ("bus") ("subway") ("railway") ("plane")
        ("travel")
        ("child")
        (:endgrouptag)
...
(use-package org-pretty-tags
  ...
  (setq org-pretty-tags-surrogate-strings
        ;; TODO change icons into material icons set.
        `(("ARCHIVE" . ,(all-the-icons-material "archive" :face '(:foreground "gray")))
          ("noexport" . ,(all-the-icons-material "not_interested" :face '(:foreground "orange")))
          ("deprecated" . ,(all-the-icons-material "strikethrough_s" :face '(:foreground "sienna")))
          ...
          ("plane" . ,(all-the-icons-material "local_airport" :face '(:foreground "LightGray")))
          ...
          ("camera" . ,(all-the-icons-material "camera" :face '(:foreground "DarkSeaGreen")))
          ...
          ;; -----------------------------------------------------
          ;; Programming
          ("@programming" . ,(all-the-icons-material "code" :face '(:foreground "LightSlateBlue")))
