...
(setq org-agenda-category-icon-alist
      `(("Diary" ,(list (all-the-icons-faicon "file-text-o")) nil nil :ascent center)
        ...
        ("Code" ,(list (all-the-icons-faicon "file-code-o")) nil nil :ascent center)
        ...
        ("C" ,(list (all-the-icons-alltheicon "c")) nil nil :ascent center)
        ("C++" ,(list (all-the-icons-alltheicon "cplusplus")) nil nil :ascent center)
        ("Go" ,(list (all-the-icons-alltheicon "go")) nil nil :ascent center)
