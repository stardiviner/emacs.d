...
(setq org-agenda-category-icon-alist
      `(("Diary" ,(list (all-the-icons-faicon "file-text-o")) nil nil :ascent center)
        ("Todo" ,(list (all-the-icons-faicon "check-square-o")) nil nil :ascent center)
        ...
        ("Bug" ,(list (all-the-icons-faicon "bug")) nil nil :ascent center)
        ("Issue" ,(list (all-the-icons-octicon "issue-opened")) nil nil :ascent center)
        ...
        ("Analysis" ,(list (all-the-icons-faicon "bar-chart")) nil nil :ascent center)
        ("Email" ,(list (all-the-icons-material "email")) nil nil :ascent center)
        ("Idea" ,(list (all-the-icons-faicon "lightbulb-o")) nil nil :ascent center)
        ("Project" ,(list (all-the-icons-faicon "tasks")) nil nil :ascent center)
        ("Agriculture" ,(list (all-the-icons-faicon "leaf")) nil nil :ascent center)
        ...
        ("University" ,(list (all-the-icons-faicon "university")) nil nil :ascent center)
        ("Linux" ,(list (all-the-icons-faicon "linux")) nil nil :ascent center)
        ...
        ("JavaScript" ,(list (all-the-icons-alltheicon "javascript")) nil nil :ascent center)
        ...
        ("Web" ,(list (all-the-icons-faicon "globe")) nil nil :ascent center)
        ...
        ;; <Life>
        ("Home" ,(list (all-the-icons-faicon "building-o")) nil nil :ascent center)
        ...
        ("Hospital" ,(list (all-the-icons-faicon "hospital-o")) nil nil :ascent center)
        ...
        ("Sex" ,(list (all-the-icons-faicon "female")) nil nil :ascent center)
        ...
        ("Talk" ,(list (all-the-icons-faicon "comments")) nil nil :ascent center)
        ("Video-Call" ,(list (all-the-icons-material "video_call")) nil nil :ascent center)
        ("Call" ,(list (all-the-icons-faicon "phone")) nil nil :ascent center)
        ...
        ("Search" ,(list (all-the-icons-faicon "search")) nil nil :ascent center)
        ("Mobile" ,(list (all-the-icons-octicon "device-mobile")) nil nil :ascent center)
        ("Weixin" ,(list (all-the-icons-faicon "weixin")) nil nil :ascent center)
        ("QQ" ,(list (all-the-icons-faicon "qq")) nil nil :ascent center)
