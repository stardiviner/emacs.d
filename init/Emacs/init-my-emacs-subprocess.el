...
;;
;; A service is an individual process such as you would otherwise launch in a
;; shell - e.g. serving the contents of a directory on localhost port 7878:
;;
;;   you@yourbox $ python -m SimpleHTTPServer 7878
;;
;; In production you might (read really, really should) have a whole webserver
;; to take care of that sort of thing, but while working you take a simpler
;; route.
;;
...
;; ## Service Groups ##
;;
;; With Service Groups things get even More Fun. Service Groups allow you to
;; define a group of conceptually related Services that you will want to launch
;; simultaneously.
;;
;; ## By Way Of Example ##
;;
;; Let's say you are plausibly working on a "Server" that will talk to a
;; "Client". Having defined the Sevices my-server and my-client you can then
...
;; ## Reloading ##
;;
;; Dizzee also provides a reloader to restart your service when you make changes
